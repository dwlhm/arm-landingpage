  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className="text-center sm:text-left sm:grid sm:grid-rows-2 lg:grid-rows-1 lg:grid-cols-3 gap-4 pb-0 px-5 h-full">
          ...
          <div className="flex justify-end items-center col-span-2">
            <div className="sm:px-10 pt-3 lg:pt-1 pb-10 lg:pb-0 w-full grid sm:grid-cols-3">
              ...
              <div>
                ...
                <div className="row-span-2 flex flex-col items-center justify-center pt-5" id={styles.sholatWrap}>
                  <img className="w-60" src="/HP_1_Desktop.png" />
